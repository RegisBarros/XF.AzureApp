...
namespace XF.AzureApp.iOS
{
    ...
    public partial class AppDelegate : global::Xamarin.Forms.Platform.iOS.FormsApplicationDelegate, IAuthenticate
    {
        ...
        public async Task<bool> AuthenticateAsync()
        {
            ...
            try
            {
                if (user == null)
                {
                    ...
                    user = await AzureAppManager.DefaultManager.CurrentClient.LoginAsync(UIApplication.SharedApplication.KeyWindow.RootViewController, 
                        MobileServiceAuthenticationProvider.Google, Models.Constants.URLScheme);
        ...
        public async Task<bool> LogoutAsync()
        {
            ...
            try
            {
                if (user != null)
                {
                    ...
                    await AzureAppManager.DefaultManager.CurrentClient.LogoutAsync();
        ...
        {
            return AzureAppManager.DefaultManager.CurrentClient.ResumeWithURL(url);
        }
    }
}
